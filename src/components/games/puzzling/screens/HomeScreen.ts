...
export class HomeScreen extends Container {
    ...
    /** Button back  */
    // private backButton: RippleButton;
    ...
    constructor() {
        ...
        //     this.navigate = true; // Устанавливаем состояние для перехода
        // });
    ...
    public resize(width: number, height: number) {
        ...
        // Уменьшите ширину в 2 раза
        // this.backButton.height = 0.5; // Уменьшите высоту в 2 раза
